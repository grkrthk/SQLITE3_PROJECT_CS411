...
fullname_grk::= CONSTRAINT nm(X).  {pParse->alter_flag=1; pParse->check_constraint  = X;}
fullname_grk::= CONSTRAINT. {pParse->alter_flag =1;}


//%type nmk {Token}
//nmk(X) ::= STRING(X).     {pParse->constraintName = X;}
